...
print(set_3)#{'1', '5', '2', '4', '3'}
print(set_4)#frozenset({1, 2, 3, 4})

#2.判断元素是否在集合中print("\n2.元素是否在集合中：")print('集合中有6这个元素：%s' % (6 in set_1)) # 判断集合中是否有此元素print('集合中没有7这个元素：%s' % (7 not in set_1)) # 判断集合中是否有此元素

# 2.判断元素是否在集合中
print("\n2.元素是否在集合中：")
print('集合中有6这个元素：%s' % (6 in set_1)) # 判断集合中是否有此元素 集合中有6这个元素：False
print('集合中没有7这个元素：%s' % (7 not in set_1)) # 判断集合中是否有此元素 集合中没有7这个元素：True
